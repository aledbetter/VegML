...
public class MapLearningCurve {
	...
	public static void main(String [] args) {
		...
		//VFileUtil.loadDataSets(dataSetToUse, filename, odsList, odsValList, dsTuneList, dsTuneValList, dsTestList, dsTestValList, ds2TestList, ds2TestValList, vset, percentTune, percentTest);			
