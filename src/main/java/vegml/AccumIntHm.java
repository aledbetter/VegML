 ...
 */
class AccumIntHm extends Accum {
	private static final long serialVersionUID = -6318994389735930062L;
	...
	public long getFirstMostProbablityValue() {
		if (total == 0) return 0;
		makeMostProbable();
		return (long)mostProb.get(0).value;
	}
	@Override
