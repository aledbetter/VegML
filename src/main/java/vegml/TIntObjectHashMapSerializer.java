 ...
 */
class TIntObjectHashMapSerializer extends Serializer<TIntObjectHashMap<String>> {

    /**
     * Based on writeExternal in the hierarchy of TIntIntHashMap.
     */
	@Override
    public void write(Kryo kryo, Output output, TIntObjectHashMap<String> map) {
    ...
    @Override
    public TIntObjectHashMap<String> read(Kryo kryo, Input input, Class type) {
        ...
        TIntObjectHashMap<String> map = new TIntObjectHashMap<>(size, Constants.DEFAULT_LOAD_FACTOR, noEntryVal);
        ...
        //System.out.println("LOAD XX: " + size);
        return map;
    }
}
